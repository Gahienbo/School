...
{\fontfamily{pag}\selectfont Čím více druhů,} \textsc{řezů,} {\scriptsize velikostí}, barev písma \underline{a jiných efektů} použijeme, tím {\large \textit{profesionálněji}} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen!}
\end{adjustwidth}
